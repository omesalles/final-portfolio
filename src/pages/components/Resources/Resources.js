...
export function Resources() {
  let title = "Resources";
  let panelLeft = ["W3Schools", "MDN Web Docs", "CSS Zen Garden", "immutable", "WebFlow"];
  let panelRight = null;
  let panelMiddle = ["This website is the starting point for anything related with web development "+
